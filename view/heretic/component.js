...
import AOS from "#lib/3rdparty/aos/js/aos";
...
export default class {
    ...
    async onCreate(input, out) {
        ...
        await import( /* webpackChunkName: "aos" */ "#lib/3rdparty/aos/sass/aos.scss");
    ...
    interceptClickEvent(e) {
        ...
        if (!window.__heretic.routingStop && target.tagName === "A") {
            ...
            if (!target.getAttribute("route") && !target.getAttribute("nointercept") && url && url.match(/^\//)) {
                e.preventDefault();
    ...
    async onMount() {
        ...
        window.__heretic.darkMode = darkMode;
    ...
    onDarkMode(flag) {
        ...
        window.__heretic = window.__heretic || {};
        window.__heretic.darkMode = flag;
        document.dispatchEvent(new CustomEvent("darkMode", {
            flag,
        }));
    }
